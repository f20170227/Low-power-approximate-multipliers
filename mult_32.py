...
res1 = []
num1 = [6, 7, 8, 9, 10]
mean_error_distance = [0, 0, 0, 0, 0]
mean_relative_error_distance = [0., 0., 0., 0., 0.]
normalized_error_distance = [0., 0., 0., 0., 0.]
normailzed_relative_error_distance = [0., 0., 0., 0., 0.]
acceptance_prob = [0., 0., 0., 0., 0.]
...
for g in range (5):
	...
	plt.plot(x,yans)
	plt.title ('RELATIVE ERROR(%) 32 BIT MULTIPLIER SCHEME 1')
...
plt.title ('32 BIT MULTIPLIER SCHEME 1')
plt.xticks(p,l)
